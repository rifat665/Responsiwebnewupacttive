...
const translations = {
    tr: {
      ...
      politic: "Gizlilik Politikası 1. Giriş Bu Gizlilik Politikası, [Şirket Adı] (bundan sonra biz, bizim veya şirket olarak anılacaktır) tarafından, [web sitenizin adı veya uygulamanızın adı] üzerinden toplanan kişisel bilgilerin nasıl kullanıldığını, saklandığını ve korunduğunu açıklar. Gizliliğiniz bizim için önemlidir ve bu politikanın, kişisel bilgilerinizi nasıl işlediğimiz hakkında size açık ve anlaşılır bilgiler sağlamayı amaçladığını belirtmek isteriz.2. Toplanan Kişisel Bilgiler Web sitemizi ziyaret ettiğinizde veya hizmetlerimizi kullandığınızda, aşağıdaki kişisel bilgileri toplayabiliriz: İletişim bilgileri (ad, soyad, e-posta adresi, telefon numarası) Kullanıcı davranışları (giriş bilgileri, kullanım verileri) Diğer sağladığınız bilgiler (formlar, yorumlar, vb.)3. Kişisel Bilgilerin Kullanımı Topladığımız kişisel bilgileri şu amaçlarla kullanabiliriz: İletişim kurmak ve taleplerinizi yerine getirmek Web sitemizin işleyişini sağlamak ve geliştirmek Size özel içerik, reklam veya teklifler sunmak Yasal gerekliliklere uymak ve düzenleyici kurumlarla iletişime geçmek. 4. Kişisel Bilgilerin Paylaşılması Kişisel bilgilerinizi, şu haller dışında üçüncü şahıslarla paylaşmayacağız: Hizmet sağlamak amacıyla, güvenilir üçüncü taraf hizmet sağlayıcılarla paylaşılabilir. Yasal zorunluluklar veya yasal süreçler gereği, yetkililerle paylaşılabilir. Kullanıcı izniyle, pazarlama veya diğer ticari amaçlarla paylaşılabilir.5. Çerezler ve İzleme Teknolojileri Web sitemizde, kullanıcı deneyimini iyileştirmek amacıyla çerezler ve izleme teknolojileri kullanılabilir. Bu teknolojiler, ziyaretçi sayısını izlemek, sayfa görüntülemelerini analiz etmek ve kişiselleştirilmiş içerik sağlamak için kullanılır.6. Bilgilerin Güvenliği Kişisel bilgilerinizi korumak için uygun güvenlik önlemleri alıyoruz. Ancak, internet üzerinden veri iletimi tamamen güvenli değildir ve hiçbir güvenlik sisteminin mutlak güvenliği garanti edemeyeceğini unutmamalısınız.7. Verilerin Saklanması ve Erişim Kişisel bilgilerinizi yalnızca gerekli olduğu süre boyunca saklayacağız. Ayrıca, kişisel bilgilerinizin doğru ve güncel olmasını sağlamak için gerekli adımları atacağız. Kişisel verilerinize erişim hakkınız bulunmakta olup, bu verileri güncelleme veya silme talebinde bulunabilirsiniz.8. Yasal Haklarınız Veri koruma yasaları gereği, kişisel bilgilerinizi toplama ve işleme hakkınızla ilgili yasal haklara sahipsiniz. Bu haklar arasında, bilgilerinizi düzeltme, silme ve sınırlama hakları yer almaktadır.9. Politika Değişiklikleri Bu Gizlilik Politikası zaman zaman güncellenebilir. Herhangi bir değişiklik yapıldığında, yeni politika metni web sitemizde yayınlanacaktır. Lütfen düzenli olarak bu sayfayı kontrol edin.10. İletişim Bu Gizlilik Politikası ile ilgili herhangi bir sorunuz veya talebiniz olursa, bizimle iletişime geçebilirsiniz:E-posta: responsiweb07@gmail.com",    },
    en: {
      work: "Announcements",
      contact: "Contact",
      about: "About",
    ...
    fra: {
      ...
      politic: "Politique de Confidentialité. 1. Introduction Cette Politique de Confidentialité explique comment [Nom de l'entreprise] (ci-après désigné par nous, notre ou la société) collecte, utilise, stocke et protège les données personnelles via [le nom de votre site ou application]. Votre vie privée est importante pour nous, et nous souhaitons fournir des informations claires sur la façon dont nous traitons vos données.2. Données Personnelles Collectées Lorsque vous visitez notre site ou utilisez nos services, nous pouvons collecter : Informations de contact (nom, prénom, adresse e-mail, numéro de téléphone) Comportement utilisateur (données de connexion, d'utilisation) Autres informations que vous fournissez (formulaires, commentaires, etc.)3. Utilisation des Données Nous pouvons utiliser les données collectées à des fins suivantes : Communiquer avec vous et répondre à vos demandes Exploiter et améliorer notre site Fournir du contenu, des offres ou publicités personnalisées Respecter les obligations légales et communiquer avec les autorités. 4. Partage des Données Nous ne partagerons vos données que dans les cas suivants : Avec des prestataires de services de confiance Pour des raisons légales ou procédures judiciaires Avec votre consentement à des fins de marketing ou commerciales. 5. Cookies et Technologies de Suivi Nous utilisons des cookies et technologies similaires pour améliorer l’expérience utilisateur, analyser les visites et proposer un contenu personnalisé.6. Sécurité des Données Nous mettons en œuvre des mesures de sécurité appropriées pour protéger vos données personnelles. Cependant, aucune transmission ou stockage sur Internet n’est totalement sécurisé.7. Conservation et Accès Nous conservons vos données aussi longtemps que nécessaire. Vous avez le droit d'accéder, de mettre à jour ou de demander la suppression de vos données.8. Vos Droits Légaux Conformément aux lois sur la protection des données, vous disposez de droits : rectification, suppression, ou limitation de traitement.9. Modifications de la Politique Cette Politique peut être mise à jour. Toute modification sera publiée sur notre site. Veuillez consulter régulièrement cette page.10. Contact Pour toute question concernant cette Politique de Confidentialité, vous pouvez nous contacter : Email : responsiweb07@gmail.com",
    }
  };
