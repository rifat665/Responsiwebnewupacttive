...
privacyBtn.addEventListener("click", () =>{
    ...
    centerBox.style.height = '655px';
    politic.style.height = '600px';
...
,    },
    en: {
      ...
      inftext: "Hi, I'm Mehmet, a web designer. I'm passionate about creating creative and user-friendly websites. Following modern design trends, I aim to create functional and aesthetically pleasing digital experiences. Understanding my clients' needs, providing them with customized solutions, and representing their projects in the best way possible in the digital world is my priority. I provide a wide range of services from web design to SEO. If you need quality and effective web design, I'd be happy to work with you.",
      politic: "Privacy Policy<br><br>1. Introduction This Privacy Policy explains how [Company Name] (hereinafter referred to as we, us, or the company) collects, uses, stores, and protects personal information through [your website or app name]. Your privacy is important to us, and we aim to provide clear and understandable information about how we process your data.<br><br>2. Collected Personal Data When you visit our website or use our services, we may collect the following personal information: Contact details (name, surname, email address, phone number) User behavior (login data, usage data) Other information you provide (forms, comments, etc.)<br><br>3. Use of Personal Information We may use the collected data for the following purposes: To communicate with you and fulfill your requests To operate and improve our website To provide personalized content, ads, or offers To comply with legal requirements and contact regulatory bodies<br><br>4. Sharing Personal Information We will not share your personal data with third parties except in the following cases: With trusted third-party service providers to operate our services With authorities due to legal obligations or proceedings With your consent for marketing or other business purposes<br><br>5. Cookies and Tracking Technologies We may use cookies and tracking technologies to enhance the user experience, monitor visitor counts, analyze page views, and provide personalized content.<br><br>6. Data Security We take appropriate security measures to protect your personal data. However, no internet transmission or storage system is 100% secure. Please be aware of the inherent risks.<br><br>7. Data Retention and Access We will retain your personal data only as long as necessary. You have the right to access, update, or request deletion of your data.<br><br>8. Your Legal Rights According to data protection laws, you have rights related to your data, including the right to correct, delete, or restrict processing.<br><br>9. Policy Changes This Privacy Policy may be updated from time to time. Changes will be posted on our website. Please check this page regularly.<br><br>10. Contact If you have any questions or requests regarding this Privacy Policy, you may contact us:<br><br>Email: adasu07@icloud.com",
    ...
    alm: {
      ...
      inftext: "Hallo, ich bin Mehmet, ich bin Webdesigner. Ich baue mit Leidenschaft kreative und benutzerfreundliche Websites. Indem ich modernen Designtrends folge, möchte ich funktionale und ästhetisch ansprechende digitale Erlebnisse schaffen. Die Bedürfnisse meiner Kunden zu verstehen, ihnen maßgeschneiderte Lösungen anzubieten und ihre Projekte optimal in der digitalen Welt darzustellen, ist meine Priorität. Ich biete eine breite Palette von Dienstleistungen von Webdesign bis SEO. Wenn Sie hochwertiges und effektives Webdesign benötigen, würde ich gerne mit Ihnen zusammenarbeiten.",
      politic: "Datenschutzerklärung<br><br>1. Einführung Diese Datenschutzerklärung erläutert, wie [Firmenname] (im Folgenden als wir, uns oder das Unternehmen bezeichnet) über [Name Ihrer Website oder App] personenbezogene Daten sammelt, verwendet, speichert und schützt. Ihre Privatsphäre ist uns wichtig, und wir möchten Ihnen klare und verständliche Informationen über den Umgang mit Ihren Daten geben.<br><br>2. Erhobene personenbezogene Daten Wenn Sie unsere Website besuchen oder unsere Dienste nutzen, können folgende personenbezogene Daten erfasst werden: Kontaktdaten (Name, Nachname, E-Mail-Adresse, Telefonnummer) Nutzerverhalten (Anmeldedaten, Nutzungsdaten) Weitere bereitgestellte Informationen (Formulare, Kommentare usw.)<br><br>3. Nutzung der personenbezogenen Daten Die gesammelten Daten können zu folgenden Zwecken verwendet werden: Kommunikation und Bearbeitung Ihrer Anfragen Betrieb und Verbesserung unserer Website Personalisierte Inhalte, Werbung oder Angebote Bereitstellung Gesetzlichen Verpflichtungen nachkommen und mit Behörden kommunizieren<br><br>4. Weitergabe personenbezogener Daten Eine Weitergabe erfolgt nur in folgenden Fällen: An vertrauenswürdige Drittanbieter zur Erbringung unserer Dienste An Behörden im Rahmen gesetzlicher Pflichten Mit Ihrer Zustimmung zu Marketingzwecken oder geschäftlichen Zwecken<br><br>5. Cookies und Tracking-Technologien Wir verwenden ggf. Cookies und Tracking-Technologien, um die Benutzererfahrung zu verbessern, Besucherzahlen zu analysieren und personalisierte Inhalte bereitzustellen.<br><br>6. Datensicherheit Wir treffen geeignete Sicherheitsmaßnahmen zum Schutz Ihrer personenbezogenen Daten. Dennoch kann keine Internetübertragung oder Speicherung absolut sicher sein. Seien Sie sich dieses Risikos bewusst.<br><br>7. Speicherung und Zugriff Wir speichern Ihre Daten nur so lange wie nötig. Sie haben das Recht auf Zugriff, Aktualisierung oder Löschung Ihrer Daten.<br><br>8. Ihre Rechte gemäß Gesetz Sie haben gemäß Datenschutzgesetzen Rechte in Bezug auf Ihre Daten, z. B. auf Berichtigung, Löschung oder Einschränkung der Verarbeitung.<br><br>9. Änderungen dieser Richtlinie Diese Datenschutzerklärung kann gelegentlich aktualisiert werden. Änderungen werden auf unserer Website veröffentlicht. Bitte prüfen Sie diese Seite regelmäßig.<br><br>10. Kontakt Bei Fragen oder Anliegen zur Datenschutzerklärung kontaktieren Sie uns bitte:<br><br>E-Mail: adasu07@icloud.com",
    },
    fra: {
      work: "Annonces",
      contact: "Contact",
      ...
      inftext: "Bonjour, je suis Mehmet, je suis concepteur de sites Web. Je suis passionné par la création de sites Web créatifs et conviviaux. En suivant les tendances de design modernes, je vise à créer des expériences numériques fonctionnelles et esthétiques. Comprendre les besoins de mes clients, leur proposer des solutions personnalisées et représenter leurs projets de la meilleure façon possible dans le monde numérique est ma priorité. Je propose une large gamme de services allant de la conception de sites Web au référencement. Si vous avez besoin d'une conception Web de qualité et efficace, je serais heureux de travailler avec vous.",
